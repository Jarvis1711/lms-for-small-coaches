...
STATUSES = ["planned", "in-session", "assessment", "mastered"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="LMS for Small Coaches",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="Education",
        ENTITY_SINGULAR="Lms Small Learning Unit",
        ENTITY_PLURAL="Lms Small Learning Units",
    )
